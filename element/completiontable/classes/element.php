...
class element extends \mod_customcert\element {
    ...
    public function render_form_elements($mform) {
         ...
         */
        protected
        function has_turn_of_the_year(\stdClass $reccurringrange)
        {
         ...
         */
        protected
        function in_start_year($date, \stdClass $range)
        {
            $intdate = $this->build_number_from_date($date);
            $intstart = $this->build_number_from_date($range->startdate);
            $intend = $this->build_number_from_date($range->enddate);
         ...
         */
        protected
        function get_matched_recurring_range($date, \stdClass $range)
        {
         ...
         */
        protected
        function build_number_from_date($date)
        {
         ...
         */
        protected
        function format_date_string($datestring, array $formatdata)
        {
         ...
         */
        protected
        function get_date_placeholders($date)
        {
            return [
         ...
         */
        protected
        function get_range_placeholders(\stdClass $range)
        {
            return [
         ...
         */
        protected
        function get_recurring_range_placeholders(\stdClass $range)
        {
            return [
         ...
         */
        private
        function get_completion_date($cmid, $user, $preview)
        {
            global $DB;
            $cm = null;
            try {
         ...
         */
        private
        function render_table($text, $user, $preview)
        {
            global $DB;
